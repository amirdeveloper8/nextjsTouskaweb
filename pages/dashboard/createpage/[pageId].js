...
import CreateAdd from "../../../components/sections/create/simple/CreateAdd";
...
const CreatePage = (props) => {
  ...
  const addsSec = authCtx.addsSection;
  ...
  return (
    <section className="dashboard">
      ...
      {addsSec && <CreateAdd pageId={pageId} getData={getDataHandler} />}
    </section>
  );
};
