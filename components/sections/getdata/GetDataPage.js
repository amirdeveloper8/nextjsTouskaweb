      ...
      <section className={classes.page}>
        ...
        {sections.map((sec) => (
          ...
          >
            ...
            <OrderSec data={sec} pageId={pageId} getData={getData} />
            ...
            {sec.type_id === 17 && (
              <div>
                ...
                <div className="d-block w-75 m-auto" dir="ltr">
                  ...
                  <div className="updateForm">
                    {updateOne && <UpdateBlog data={sec} getData={getData} />}
                    <CloseButton
                      className={classes.closeBtn}
                      onClick={noUpdateHandler}
                    />
            ...
            {(sec.type_id === 8 || sec.type_id === 1 || sec.type_id === 13) &&
              sec.button.length !== 0 && (
                <UpdateButtons data={sec} getData={getData} />
              )}
          </div>
        ))}
      </section>
