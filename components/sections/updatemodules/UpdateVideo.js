...
const UpdateVideo = (props) => {
  ...
  if (titleValue || subValue || srcValue || valueBox) {
    updateIsValid = true;
  }
  ...
  const submitHandler = async (event) => {
...

    {
      valueBox &&
        !titleValue &&
        fData.append("title", props.sec.title.split("#")[0] + `#${valueBox}`);
    }
    {
      valueBox &&
        titleValue &&
        fData.append("title", titleValue + `#${valueBox}`);
    }
    {
      !valueBox &&
        titleValue &&
        fData.append("title", titleValue + `#${props.sec.title.split("#")[1]}`);
    }
        ...
        <Row className={classes.control}>
          ...
          >
            ...
            <Form.Control
              ...
              required
              value={
                resetTitleValue ? titleValue : props.sec.title.split("#")[0]
              }
